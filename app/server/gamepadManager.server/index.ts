...
const addMappings = () => {
  sdl.controller.addMappings([
    ...
    "030048f67e0500001720000011810000,NSO SNES Controller,a:b1,b:b0,x:b2,y:b3,back:b8,start:b9,leftshoulder:b4,rightshoulder:b5,dpup:h0.1,dpdown:h0.4,dpleft:h0.8,dpright:h0.2,lefttrigger:b6,righttrigger:b7,platform:Linux,",
    ...
    "0300b7e67e050000192000000000680c,NSO N64 Controller,a:b0,b:b1,dpdown:b12,dpleft:b13,dpright:b14,dpup:b11,guide:b5,leftshoulder:b9,lefttrigger:a4~,leftx:a0,lefty:a1,rightshoulder:b10,righttrigger:b7,start:b6,-rightx:b2,+rightx:b4,-righty:b3,+righty:+a5,platform:Windows,",
