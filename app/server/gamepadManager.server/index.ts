...
const addMappings = () => {
  sdl.controller.addMappings([
    ...
    "0300b7e67e0500001920000000000000,NSO N64 Controller,a:b0,b:b1,dpdown:b12,dpleft:b13,dpright:b14,dpup:b11,guide:b5,leftshoulder:b9,lefttrigger:a4~,leftx:a0,lefty:a1,rightshoulder:b10,righttrigger:b7,start:b6,-rightx:b2,+rightx:b4,-righty:b3,+righty:+a5,platform:Windows,",
