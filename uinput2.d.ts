...
declare module "uinput2" {
  export interface InputIdOptions {
    busType: number;
    vendor: number;
    product: number;
    version: number;
  ...
  export class UInput {
    ...
    create(options: DeviceOptions): Promise<void>;
    sendEvent(
      type: number,
      code: number,
      value: number,
    ...
    keyEvent(code: number, press?: boolean): Promise<void>;
    emitCombo(code: number[]): Promise<void>;
  }

  export function setup(options: SetupOptions): Promise<UInput>;

  export const EV_SYN: number;
  export const EV_KEY: number;
  export const EV_REL: number;
  export const EV_ABS: number;
  export const EV_MSC: number;
  export const EV_SW: number;
  export const EV_LED: number;
  export const EV_SND: number;
  export const EV_REP: number;
  export const EV_FF: number;
  export const EV_PWR: number;
  export const EV_FF_STATUS: number;
  export const EV_MAX: number;
  export const EV_CNT: number;
  export const SYN_REPORT: number;
  export const SYN_CONFIG: number;
  export const SYN_MT_REPORT: number;
  export const SYN_DROPPED: number;
  ...
  export const KEY_HANGUEL: number;
  ...
  export const KEY_SCREENLOCK: number;
  export const KEY_DIRECTION: number;
  ...
  export const KEY_BRIGHTNESS_ZERO: number;
  export const KEY_DISPLAY_OFF: number;
  export const KEY_WIMAX: number;
  ...
  export const BTN_X: number;
  export const BTN_Y: number;
  ...
  export const KEY_MIN_INTERESTING: number;
  ...
  export const ID_BUS: number;
  export const ID_VENDOR: number;
  export const ID_PRODUCT: number;
  export const ID_VERSION: number;
  ...
  export const MT_TOOL_FINGER: number;
  export const MT_TOOL_PEN: number;
  export const MT_TOOL_MAX: number;
  export const FF_STATUS_STOPPED: number;
  export const FF_STATUS_PLAYING: number;
  export const FF_STATUS_MAX: number;
  export const FF_RUMBLE: number;
  export const FF_PERIODIC: number;
  export const FF_CONSTANT: number;
  export const FF_SPRING: number;
  export const FF_FRICTION: number;
  export const FF_DAMPER: number;
  export const FF_INERTIA: number;
  export const FF_RAMP: number;
  export const FF_EFFECT_MIN: number;
  export const FF_EFFECT_MAX: number;
  export const FF_SQUARE: number;
  export const FF_TRIANGLE: number;
  export const FF_SINE: number;
  export const FF_SAW_UP: number;
  export const FF_SAW_DOWN: number;
  export const FF_CUSTOM: number;
  export const FF_WAVEFORM_MIN: number;
  export const FF_WAVEFORM_MAX: number;
  export const FF_GAIN: number;
  export const FF_AUTOCENTER: number;
  export const FF_MAX: number;
  export const FF_CNT: number;
  export const UI_DEV_CREATE: number;
  export const UI_DEV_DESTROY: number;
  export const UI_SET_EVBIT: number;
  export const UI_SET_KEYBIT: number;
  export const UI_SET_RELBIT: number;
  export const UI_SET_ABSBIT: number;
  export const UI_SET_MSCBIT: number;
  export const UI_SET_LEDBIT: number;
  export const UI_SET_SNDBIT: number;
  export const UI_SET_FFBIT: number;
  export const UI_SET_PHYS: number;
  export const UI_SET_SWBIT: number;
  export const UI_SET_PROPBIT: number;
  export const UI_BEGIN_FF_UPLOAD: number;
  export const UI_END_FF_UPLOAD: number;
  export const UI_BEGIN_FF_ERASE: number;
  export const UI_END_FF_ERASE: number;
  export const EV_UINPUT: number;
  export const UI_FF_UPLOAD: number;
  export const UI_FF_ERASE: number;
  export const UINPUT_MAX_NAME_SIZE: number;
